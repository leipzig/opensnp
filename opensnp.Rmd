...
knitr::kable(agdfilt,caption="Lactose breakdown - rs4988235(G) and rs182549(C) are predictive of lactose intolerance")


```

Which combinations differ? There are several 2 two-way comparisons to make. I am most curious about the high risk GG/CC allele
```{r}
